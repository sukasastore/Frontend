  ...
  return (
    <div>
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-sols-4 gap-8 mt-[30px] mb-[30px]'>
        <HomeMiniCard image={"https://images.ctfassets.net/23u853certza/2alPBNdBAcXwckvXjbjWvH/542aac95909dbaa25b9774eb0e092860/3DLivingroom.png?w=960&q=90&fm=webp"} heading={"Boost your sales"} subText={"91% of Enatega orders are extra sales you wouldn’t otherwise get."} backColor={"#fff0ee"} headingColor={"#cb5965"}/>
        ...
        <HomeMiniCard image={"https://images.ctfassets.net/23u853certza/7cXP59KeAyDH1RT7fIi39K/620cc38c08a8a8232bcf0e2db1f15a44/WoltDriveIllustration.png?w=960&q=90&fm=webp"} heading={"Power online sales with same-hour deliveries"} subText={"Add Enatega Drive logistics for fast, affordable express deliveries for e-commerce. "} backColor={"#f0faef"} headingColor={"#1dc707"}/>
      </div>
    </div>
  )
}
