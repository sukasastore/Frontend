...
// cards data
const cards=[
    {heading:"Grow with Sukasa",text:"Access our active customer base by offering pickup and delivery on the Sukasa app.",image:growth,color:"#f7fbfe"},
    {heading:"Get more orders",text:"With Sukasa, you can increase your orders by reaching our active customers. Joining is free and pricing is commission based.",image:getMoreOrders,color:"#faf7fc"},
    {heading:"Deliver to more customers",text:"After an order is placed, Sukasa rider partners deliver to your customers in about 30 minutes. ",image:deliverMoreCustomers,color:"#fbfbfb"}
    ]

// Side Card Componet Data
const sideCards=[
{image:enategaApp,heading:"How Sukasa works",subHeading:"A customer browses the Sukasa app and places an order from your store. The order appears in the Merchant App for you to complete. Once packed and ready, a courier partner will arrive to pick up the order and deliver the goods to the customer. In total, it takes about 30 minutes for the customer to receive and enjoy their order.",right:false },
